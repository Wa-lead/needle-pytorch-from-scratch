...
def test_cifar10_dataset(train):
    dataset = ndl.data.CIFAR10Dataset("/Users/waleedalasad/Documents/GitHub/hw4/python/needle/data/cifar-10-batches-py", train=train)
    if train:
...
def test_cifar10_loader(batch_size, train, device):
    cifar10_train_dataset = ndl.data.CIFAR10Dataset("/Users/waleedalasad/Documents/GitHub/hw4/python/needle/data/cifar-10-batches-py", train=True)
...
def test_ptb_dataset(batch_size, bptt, train, device):
    ...
    corpus = ndl.data.Corpus("/Users/waleedalasad/Documents/GitHub/hw4/python/needle/data/ptb")
    if train:
